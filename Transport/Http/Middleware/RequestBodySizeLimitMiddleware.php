...
/**
 * Rejects a request whose buffered body exceeds a configured byte cap with an id-less JSON-RPC error on
 * HTTP 413, passing a body of indeterminate size through to the HTTP server's own streaming cap.
 */
